...
' ## Create a new model 
  ...
  {%modelname}.series ..\model\lists parameters R_Calibration_FRA round0 Prices_data SU_data Special_data Other_data Exception_taxes_prices_data Exception_NestedCES_data Exception_housing_data Exception_transport_data Exception_France-ADEME_data Exception_Output-ADEME_data
