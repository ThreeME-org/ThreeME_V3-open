...
' ## Create a new model 
  ...
  call load_series("..\model\lists parameters R_Calibration_NLD round0 Prices_data SU_data Special_data Other_data Exception_taxes_prices_data Exception_NestedCES_data Exception_NLD_MATERIALS_data")
...
' Run the shock scenario (2)
'call run_scenario("scenario_ADAPT_halfway")

'Run the full scenario (2)
'call run_scenario("scenario_ADAPT")
