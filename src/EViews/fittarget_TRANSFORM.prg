...
'	for %s sagr sfoo stex sveh sgla sche sogo scon srai sroa sair spri spub setd
	for %s sagr
	  ...
	  smpl 2030 2030
	  series CI_toe_{%s} = 0.755 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.616 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.418 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s smet
      smpl 2020 2020
      series CI_toe_{%s} = 0.909 * @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 1.009 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 1.030 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 1.102 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s schem
      smpl 2020 2020
      series CI_toe_{%s} = 0.977 * @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 0.844 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.842 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.863 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s spla
      smpl 2020 2020
      series CI_toe_{%s} = 1.031* @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 0.921 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 1.001 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 1.047 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s sgla
      smpl 2020 2020
      series CI_toe_{%s} = 0.931* @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 0.661 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.620 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.674 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s spap
      smpl 2020 2020
      series CI_toe_{%s} = 0.880* @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 0.681 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.886 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 1.187 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s sfoo
      smpl 2020 2020
	  ...
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.621 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.666 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s sroa
      smpl 2020 2020
      series CI_toe_{%s} = 1.000* @elem(CI_toe_{%s}, 2015)
	  smpl 2030 2030
	  series CI_toe_{%s} = 1.000 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.983 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.734 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s swat
      smpl 2020 2020
      series CI_toe_{%s} = 1.000* @elem(CI_toe_{%s}, 2015)
	  ...
	  series CI_toe_{%s} = 1.000 * @elem(CI_toe_{%s}, 2015)
	  smpl 2040 2040
	  series CI_toe_{%s} = 1.089 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.734 * @elem(CI_toe_{%s}, 2015) 
	next 
	for %s sair
	...
	for %s sres
	  ...
	  smpl 2040 2040
	  series CI_toe_{%s} = 0.741 * @elem(CI_toe_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_{%s} = 0.580 * @elem(CI_toe_{%s}, 2015) 
	next 
...
logfittarget.append ### Start iterations for objective %objective
	 ...
	 smpl 2030 2030
	 series CH_toe = 0.487 * @elem(CH_toe, 2015)
	 smpl 2040 2040
	 series CH_toe = 0.381 * @elem(CH_toe, 2015)
      smpl 2050 2050
      series CH_toe = 0.385 * @elem(CH_toe, 2015)
...
'	for %s sagr sfoo stex sveh sgla sche sogo scon srai sroa sair spri spub setd
	for %s sagr
      ...
      series CI_toe_cpch_{%s} = 1 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 0.448 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.179 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.054 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
	...
	for %s smet
      ...
      series CI_toe_cgas_{%s} = 0.453 * @elem(CI_toe_cgas_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.181 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1.021 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s schem
      ...
      series CI_toe_cgas_{%s} = 0.41 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.164 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.049 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s spla
      ...
      series CI_toe_cgas_{%s} = 0.478 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.191 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.057 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s sgla
      ...
      series CI_toe_cgas_{%s} = 0.456 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.182 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.055 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s spap
      ...
      series CI_toe_cgas_{%s} = 0.444 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.053 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s sfoo
      ...
      series CI_toe_cgas_{%s} = 0.49 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.196 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 2.25 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
      ...
      series CI_toe_cgas_{%s} = 0.059 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 2.25 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 1 * @elem(CI_toe_cbiof_{%s}, 2015)
	...
	for %s sroa
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 1 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 1 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 0.782 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 3.754 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 0.4 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 0.917 * @elem(CI_toe_cbiof_{%s}, 2015)
      series CI_toe_chea_{%s} = 1 * @elem(CI_toe_chea_{%s}, 2015)
      smpl 2050 2050
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 0.236 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 7.208 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 0.12 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
      series CI_toe_cbiom_{%s} = 1 * @elem(CI_toe_cbiom_{%s}, 2015)
      series CI_toe_cbiof_{%s} = 0.712 * @elem(CI_toe_cbiof_{%s}, 2015)
      series CI_toe_chea_{%s} = 1 * @elem(CI_toe_chea_{%s}, 2015)
	next 
	for %s swat
      smpl 2020 2020
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 1.116 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 1 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 0.751 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 1 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
	...
	for %s sair
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 3.709 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 1 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      ...
      series CI_toe_ccoa_{%s} = 1 * @elem(CI_toe_ccoa_{%s}, 2015)
      series CI_toe_coil_{%s} = 1 * @elem(CI_toe_coil_{%s}, 2015)
      series CI_toe_cfue_{%s} = 2.497 * @elem(CI_toe_cfue_{%s}, 2015)
      series CI_toe_cpch_{%s} = 0 * @elem(CI_toe_cpch_{%s}, 2015)
      series CI_toe_cele_{%s} = 1 * @elem(CI_toe_cele_{%s}, 2015)
      series CI_toe_cgas_{%s} = 1 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
	...
	for %s sres
      ...
      series CI_toe_cgas_{%s} = 0.454 * @elem(CI_toe_cgas_{%s}, 2015)
      series CI_toe_cmga_{%s} = 1 * @elem(CI_toe_cmga_{%s}, 2015)
      series CI_toe_cbiog_{%s} = 1 * @elem(CI_toe_cbiog_{%s}, 2015)
