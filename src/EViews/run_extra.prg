...
subroutine outputs_covid 
    ...
    %report_CO2 =               "EMS_CO2_2 EMS_CO2_0 (EMS_CO2_2 - EMS_CO2_0) 100*(EMS_CO2_2/EMS_CO2_0-1) "
    %report_CO2 = %report_CO2 + "EMS_CI_CO2_2 EMS_CI_CO2_0 (EMS_CI_CO2_2 - EMS_CI_CO2_0) 100*(EMS_CI_CO2_2/EMS_CI_CO2_0-1) "
    %report_CO2 = %report_CO2 + "EMS_MAT_CO2_2 EMS_MAT_CO2_0 (EMS_MAT_CO2_2 - EMS_MAT_CO2_0) 100*(EMS_MAT_CO2_2/EMS_MAT_CO2_0-1) "
    %report_CO2 = %report_CO2 + "EMS_Y_CO2_2 EMS_Y_CO2_0 (EMS_Y_CO2_2 - EMS_Y_CO2_0) 100*(EMS_Y_CO2_2/EMS_Y_CO2_0-1) "
    %report_CO2 = %report_CO2 + "EMS_CH_CO2_2 EMS_CH_CO2_0 (EMS_CH_CO2_2 - EMS_CH_CO2_0) 100*(EMS_CH_CO2_2/EMS_CH_CO2_0-1) "

    for %ghg {%list_ghg}
       %report_CO2 = %report_CO2 + "EMS_"+%ghg+"_2 EMS_"+%ghg+"_0 "  
       %report_CO2 = %report_CO2 + "(EMS_"+%ghg+"_2 - EMS_"+%ghg+"_0) "  
       %report_CO2 = %report_CO2 + "100*(EMS_"+%ghg+"_2/EMS_"+%ghg+"_0-1) "
    next

    for %s {%list_sec}
       %report_CO2 = %report_CO2 + "EMS_CI_CO2_"+%s+"_2 EMS_CI_CO2_"+%s+"_0 "  
       %report_CO2 = %report_CO2 + "(EMS_CI_CO2_"+%s+"_2 - EMS_CI_CO2_"+%s+"_0) "  
       %report_CO2 = %report_CO2 + "100*(EMS_CI_CO2_"+%s+"_2/EMS_CI_CO2_"+%s+"_0-1) "
    next

    for %c {%list_com}
       if EMS_CO2_{%c} <> 0 then
         %report_CO2 = %report_CO2 + "EMS_CO2_"+%c+"_2 EMS_CO2_"+%c+"_0 "  
         %report_CO2 = %report_CO2 + "(EMS_CO2_"+%c+"_2 - EMS_CO2_"+%c+"_0) "  
         %report_CO2 = %report_CO2 + "100*(EMS_CO2_"+%c+"_2/EMS_CO2_"+%c+"_0-1) "
       endif
    next

    for %c {%list_com}
       if EMS_CI_CO2_{%c} <> 0 then
         %report_CO2 = %report_CO2 + "EMS_CI_CO2_"+%c+"_2 EMS_CI_CO2_"+%c+"_0 "  
         %report_CO2 = %report_CO2 + "(EMS_CI_CO2_"+%c+"_2 - EMS_CI_CO2_"+%c+"_0) "  
         %report_CO2 = %report_CO2 + "100*(EMS_CI_CO2_"+%c+"_2/EMS_CI_CO2_"+%c+"_0-1) "
       endif
    next

    for %c {%list_com}
       if EMS_CH_CO2_{%c} <> 0 then
         %report_CO2 = %report_CO2 + "EMS_CH_CO2_"+%c+"_2 EMS_CH_CO2_"+%c+"_0 "  
         %report_CO2 = %report_CO2 + "(EMS_CH_CO2_"+%c+"_2 - EMS_CH_CO2_"+%c+"_0) "  
         %report_CO2 = %report_CO2 + "100*(EMS_CH_CO2_"+%c+"_2/EMS_CH_CO2_"+%c+"_0-1) "
       endif
    next

    group CO2 {%report_CO2}


    call savetoexcel("Macro Sectors GHG CO2", "Result_France.xlsx", "YES")
