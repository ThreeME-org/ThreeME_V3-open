...
%list_com_MAT = "cagr cfor cfoo cveh cgla cpap cche cpla cmet cigo ccgo ccon crai croa cwat cair cpri cpub cmin"

%list_com_MATO = "cagr cfor cfoo cveh cgla cpap cche cpla cmet cigo ccgo ccon cpri cpub cmin"
