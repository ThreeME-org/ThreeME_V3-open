...
\noindent \kern-0.23em \noindent \begingroup \refstepcounter{equation} \label{exogenous.mdlRHO_Rn_Cons}\ref{exogenous.mdlRHO_Rn_Cons}.
        \relpenalty=10000 \binoppenalty=10000
        \ensuremath{\rho^{Rn,Cons}}~ \endgroup -- \noindent \textbf{Constant of the notianal interest rate equation (Taylor rule).}  \\ \\[-8pt]The constant is equal to zero in the baseline scenario. It can be used to simulate monetary shocks. \\
...
\subsection{From producer block}



\noindent \kern-0.23em \noindent \begingroup \refstepcounter{equation} \label{exogenous.mdlphi[f, s]}\ref{exogenous.mdlphi[f, s]}.
        \relpenalty=10000 \binoppenalty=10000
        \ensuremath{\varphi_{f, s}}~ \endgroup -- \noindent \textbf{Production share of commodity $c$ by sector $s$}  \\ \\[-8pt]



\subsection{From block ETC.... @ Paul: Et ce pour tous les blocs générés}
...
$\varphi_{f, s}$ & Cost share of input $f$ for sector $s$ & \RaggedLeft \ref{producer.mdlphi[f, s]}, & \RaggedLeft \pageref{producer.mdlphi[f, s]} \\
 \midrule 
$\varphi_{f, s}$ (2) & Production share of commodity $c$ by sector $s$ & \RaggedLeft \ref{exogenous.mdlphi[f, s]}, & \RaggedLeft \pageref{exogenous.mdlphi[f, s]} \\
 \midrule 
...
$RDEBT^{G,VAL}$ & Ratio of the Government's debt expressed in value (in percent of GDP) & \RaggedLeft \ref{government.mdlRDEBT_G_VAL}, & \RaggedLeft \pageref{government.mdlRDEBT_G_VAL} \\
 \midrule 
$\rho^{Rn,Cons}$ & Constant of the notianal interest rate equation (Taylor rule). & \RaggedLeft \ref{exogenous.mdlRHO_Rn_Cons}, & \RaggedLeft \pageref{exogenous.mdlRHO_Rn_Cons} \\
 \midrule 
